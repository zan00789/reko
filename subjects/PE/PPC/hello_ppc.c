	...
	if (r3 != null)
	{
		if (r5 > 0x00)
		{
			...
			do
			{
				...
				r3[r3_n].t0000.u0 = (byte) (int32) (int8) (r11_n & 0xFF);
				++r4;
				if ((word32) *r4 == 0x00)
					return;
				++r3_n;
...
Eq_n fn00401ADC(Eq_n r2, struct Eq_n * r3, ptr32 r25, ptr32 r26, Eq_n r27, Eq_n r28, Eq_n r29, struct Eq_n * r30, struct Eq_n * r31, word32 lr, union Eq_n & r3Out, union Eq_n & r25Out, union Eq_n & r26Out, union Eq_n & r27Out, union Eq_n & r28Out, union Eq_n & r29Out, union Eq_n & r30Out)
{
	...
	if (r27_n == -0x01)
	{
		...
		{
			r10_n[r11_n / 0x04].u0 = 0x00;
			int32 r11_n = r11_n + 0x04;
			r10_n[r11_n / 0x04].u0 = 0x00;
			r10_n[(r11_n + 0x04) / 0x04].u0 = 0x00;
			r10_n[(r11_n + 0x08) / 0x04].u0 = 0x00;
			r11_n = r11_n + 0x0C;
		}
...
Eq_n fn004026B8(Eq_n r2, struct Eq_n * r3, int32 r4, int32 r5, ptr32 r26, Eq_n r27, struct Eq_n * r28, struct Eq_n * r29, struct Eq_n * r30, Eq_n r31, ptr32 & r26Out, union Eq_n & r27Out, union Eq_n & r28Out, union Eq_n & r29Out, union Eq_n & r31Out)
{
	...
	v3->ptr0010 = r30;
	v3->t0014 = r31;
	struct Eq_n * r1_n = (char *) fp - 0x00A0;
	int32 r29_n = r4;
	if (**((word32) r2 + 116) > r3)
	{
		...
		if ((r11_n & 0x01) != 0x00 && (r11_n & 0x40) == 0x00)
		{
			...
			if (r3_n == null)
			{
				struct Eq_n * r31_n = (char *) &r1_n->t0014 + 0x0024;
				int32 r11_n = 0x00;
				int32 ctr_n;
				for (ctr_n = 0x05; ctr_n != 0x00; --ctr_n)
				{
					r31_n[r11_n / 0x0032] = (struct Eq_n) 0x00;
					int32 r11_n = r11_n + 0x04;
					r31_n[r11_n / 0x0032] = (struct Eq_n) 0x00;
					r31_n[(r11_n + 0x04) / 0x0032] = (struct Eq_n) 0x00;
					r31_n[(r11_n + 0x08) / 0x0032] = (struct Eq_n) 0x00;
					r11_n = r11_n + 0x0C;
				}
				struct Eq_n * r27_n[] = *((word32) r2 + 0x009C);
				struct Eq_n * r4_n = r27_n[r3];
				r31_n->dw002E = r29_n;
...
// 00403104: void fn00403104(Register Eq_n r2, Register (ptr32 Eq_n) r3)
void fn00403104(Eq_n r2, struct Eq_n * r3)
{
...
Eq_n fn00403744(Eq_n r2, Eq_n r3, struct Eq_n * r29, Eq_n r30, Eq_n r31, union Eq_n & r3Out, struct Eq_n & r29Out, union Eq_n & r30Out, union Eq_n & r31Out)
{
	...
	if (r4_n != 0x00)
	{
		...
		if (r11_n < 0x0100)
		{
			...
			{
				fn00403104(r2_n, &fp->aFFFFFFA0->dw0000);
				r3Out.u0 = -0x01;
				r29Out = dwLoc10;
				r30Out = dwLoc0C;
				r31Out = dwLoc08;
